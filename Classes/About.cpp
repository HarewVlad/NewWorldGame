...
bool About::init(const std::function<void(Ref *)> &func) {
  ...
  // Init autors
  std::vector<std::string> autors = {"Detective - hugues laborde",
                                     "Falling monsters - superdark",
                                     "Game background - sorry, can't find =("};
  ...
  // Back button
  backButton = Button::create("Buttons/Rect.png", cocos2d::Color3B::GRAY,
